...
interface QueryOptions<TData, TError> extends Omit<
...
interface ExtendedMutationOptions<TData, TError, TVariables> extends Omit<
...
export function useQuery<TData, TError = Error>(
  ...
  const queryFn = () =>
    apiClient<TData>(`/api/${queryKey.join('/')}`, {
      timeout,
      circuitBreaker,
    })
