...
const GRADE_THRESHOLDS: readonly {
  ...
  {
    min: GradeThresholds.A,
    grade: 'A',
    colorClass: 'bg-green-500 hover:bg-green-600',
    variant: 'default',
  },
  {
    min: GradeThresholds.B,
    grade: 'B',
    colorClass: 'bg-blue-500 hover:bg-blue-600',
    variant: 'secondary',
  },
  {
    min: GradeThresholds.C,
    grade: 'C',
    colorClass: 'bg-yellow-500 hover:bg-yellow-600',
    variant: 'outline',
  },
  {
    min: GradeThresholds.D,
    grade: 'D',
    colorClass: 'bg-orange-500 hover:bg-orange-600',
    variant: 'destructive',
  },
  {
    min: GradeThresholds.E,
    grade: 'E',
    colorClass: 'bg-red-500 hover:bg-red-600',
    variant: 'destructive',
  },
  { min: 0, grade: 'F', colorClass: 'bg-red-700 hover:bg-red-800', variant: 'destructive' },
]
