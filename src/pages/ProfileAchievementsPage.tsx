              ...
              <div className="space-y-6">
                <div className="border-l-4 border-blue-500 pl-4 py-1">
                  ...
                  <p className="text-muted-foreground mt-2">
                    Penghargaan diterima dari Dinas Pendidikan Provinsi atas kualitas pembelajaran
                    dan manajemen sekolah yang unggul.
                  </p>
                ...
                <div className="border-l-4 border-green-500 pl-4 py-1">
                  ...
                  <p className="text-muted-foreground mt-2">
                    Meraih juara pertama dalam ajang inovasi pendidikan tingkat nasional dengan
                    konsep pembelajaran berbasis teknologi.
                  </p>
                ...
                <div className="border-l-4 border-purple-500 pl-4 py-1">
                  ...
                  <p className="text-muted-foreground mt-2">
                    Mendapatkan sertifikasi sebagai sekolah ramah anak dari Komnas Perlindungan
                    Anak.
                  </p>
            ...
            <SlideRight delay={0.1}>
              ...
              <div className="space-y-6">
                <div className="border-l-4 border-yellow-500 pl-4 py-1">
                  ...
                  <p className="text-muted-foreground mt-2">
                    Tim sains kami berhasil meraih medali emas di ajang Olimpiade Sains Nasional
                    tingkat SMA.
                  </p>
                ...
                <div className="border-l-4 border-red-500 pl-4 py-1">
                  ...
                  <p className="text-muted-foreground mt-2">
                    Siswa kami meraih juara pertama dalam lomba debat bahasa Inggris tingkat
                    regional.
                  </p>
                ...
                <div className="border-l-4 border-indigo-500 pl-4 py-1">
                  ...
                  <p className="text-muted-foreground mt-2">
                    Lima siswa kami berhasil meraih beasiswa penuh untuk kuliah di universitas
