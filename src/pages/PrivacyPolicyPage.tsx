      ...
      <main id="main-content" className="flex-grow">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24">
          <div className="prose dark:prose-invert max-w-none text-muted-foreground">
            <p>
              Welcome to Akademia Pro. We are committed to protecting your privacy. This Privacy
              Policy explains how we collect, use, disclose, and safeguard your information when you
              use our school management system.
            </p>
            <h2>1. Information We Collect</h2>
            <p>
              We may collect personal information from you such as your name, email address, role
              (student, teacher, parent, admin), and other information necessary for functioning of
              school portal.
            </p>
            ...
            <p>
              We implement a variety of security measures to maintain safety of your personal
              ...
              systems, and are required to keep information confidential.
            </p>
