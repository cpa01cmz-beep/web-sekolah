...
import { MessageThread, ComposeDialog, MessageListCard } from '@/components/messages'
      ...
      <Tabs value={activeTab} onValueChange={v => setActiveTab(v as 'inbox' | 'sent')}>
        ...
        <TabsContent value="inbox" className="mt-4">
          <MessageListCard
            ...
            emptyDescription="Your inbox is empty. Messages from parents will appear here."
