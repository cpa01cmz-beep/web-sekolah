...
export const EXTRACURRICULAR_PAGE_CONTENT = {
  ...
  subtitle: 'Berbagai kegiatan ekstrakurikuler yang kami tawarkan untuk mengembangkan bakat dan minat siswa.',
  joiningSection: {
    title: 'Bergabung dengan Kami',
    description: 'Setiap siswa berhak mengikuti minimal satu kegiatan ekstrakurikuler. Pendaftaran dibuka setiap awal semester.',
