...
export const DownloadCard = memo(function DownloadCard({
  ...
  if (variant === 'vertical') {
    return (
      <div
        className={`bg-card rounded-lg shadow-sm p-6 hover:shadow-lg transition-shadow duration-200 ${className}`}
      >
        <div
  ...
  return (
    <div
      className={`flex items-center justify-between p-4 bg-card rounded-lg shadow-sm hover:shadow-lg transition-shadow duration-200 ${className}`}
    >
      <div>
