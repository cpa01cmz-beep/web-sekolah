        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <nav aria-label="Footer quick links">
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <Link
                  to="/about"
                  className="hover:text-primary focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 rounded-md px-1 -mx-1"
                >
                  About Us
                </Link>
              </li>
          ...
          <div>
            ...
            <nav aria-label="Social media links" className="flex space-x-4">
              <a
                href="#"
                className="hover:text-primary focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 rounded-md p-1 -m-1"
                aria-label="Twitter"
              >
