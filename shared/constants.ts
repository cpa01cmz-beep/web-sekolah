export const ValidationLimits = {
  ...
  PASSWORD_STRONG_MIN_LENGTH: 8,
  PHONE_MIN_LENGTH: 10,
  PHONE_MAX_LENGTH: 13,
  NISN_LENGTH: 10,
  STUDENT_ID_NUMBER_MIN_LENGTH: 3,
  STUDENT_ID_NUMBER_MAX_LENGTH: 20,
  GRADE_LEVEL_MIN: 1,
  GRADE_LEVEL_MAX: 12,
  ...
  CSP_URI_MAX_LENGTH: 2000,
  CSP_DIRECTIVE_MAX_LENGTH: 200,
  CSP_POLICY_MAX_LENGTH: 10000,
  CSP_DISPOSITION_MAX_LENGTH: 50,
  CSP_STATUS_CODE_MAX_LENGTH: 10,
  CSP_SCRIPT_SAMPLE_MAX_LENGTH: 1000,
} as const
