  ...
  return defineConfig({
    plugins: [
      ...
      VitePWA({
        ...
        manifest: {
          name: 'Akademia Pro - School Management Portal',
          short_name: 'Akademia',
          description:
            'Modern School Management Portal for Students, Teachers, Parents, and Administrators',
          theme_color: '#2563eb',
        ...
        workbox: {
          ...
          runtimeCaching: [
            ...
            {
              urlPattern: /^https:\/\/fonts\.googleapis\.com\/icons\//i,
              handler: 'CacheFirst',
              options: {
