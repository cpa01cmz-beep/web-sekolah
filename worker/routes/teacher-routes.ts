...
export function teacherRoutes(app: Hono<{ Bindings: Env }>) {
  app.get(
    ...
    ...withUserValidation('teacher', 'classes'),
    withErrorHandler('get teacher classes')(async (c: Context) => {
  ...
  app.get(
    ...
    ...withUserValidation('teacher', 'dashboard'),
    withErrorHandler('get teacher dashboard')(async (c: Context) => {
      const requestedTeacherId = c.req.param('id')
      const { teacher, classes: teacherClasses } = await CommonDataService.getTeacherWithClasses(
        c.env,
        requestedTeacherId
      )
      if (!teacher) {
      ...
      const recentGrades = await CommonDataService.getTeacherRecentGradesWithDetails(
        c.env,
        requestedTeacherId,
        5
      )
      const filteredAnnouncements = await CommonDataService.getRecentAnnouncementsByRole(
        c.env,
        'teacher',
        5
      )
  ...
  app.get(
    '/api/teachers/:id/announcements',
    ...withUserValidation('teacher', 'announcements'),
    withErrorHandler('get teacher announcements')(async (c: Context) => {
  ...
  app.get(
    ...
    ...withUserValidation('teacher', 'schedule'),
    withErrorHandler('get teacher schedule')(async (c: Context) => {
      const teacherId = c.req.param('id')
  ...
  app.get(
    ...
    ...withAuth('teacher'),
    withErrorHandler('get class students with grades')(async (c: Context) => {
      const classId = c.req.param('id')
      const teacherId = getCurrentUserId(c)

      const studentsWithGrades = await TeacherService.getClassStudentsWithGrades(
        c.env,
        classId,
        teacherId
      )
  ...
  app.post(
    ...
    withErrorHandler('create grade')(async (c: Context) => {
  ...
  app.post(
    ...
    withErrorHandler('create announcement')(async (c: Context) => {
      ...
      triggerWebhookSafely(c.env, 'announcement.created', newAnnouncement, {
  ...
  app.get(
    '/api/teachers/:id/messages',
    ...withUserValidation('teacher', 'messages'),
    validateQuery(messageTypeQuerySchema),
    withErrorHandler('get teacher messages')(async (c: Context) => {
      const teacherId = c.req.param('id')
  ...
  app.get(
    '/api/teachers/:id/messages/unread-count',
    ...withUserValidation('teacher', 'messages'),
    withErrorHandler('get teacher unread count')(async (c: Context) => {
      const teacherId = c.req.param('id')
  ...
  app.get(
    '/api/teachers/:id/messages/:parentId/conversation',
    ...withUserValidation('teacher', 'messages'),
    withErrorHandler('get teacher conversation')(async (c: Context) => {
      const teacherId = c.req.param('id')
  ...
  app.post(
    ...
    withErrorHandler('send teacher message')(async (c: Context) => {
      const teacherId = getCurrentUserId(c)
  ...
  app.post(
    '/api/teachers/:id/messages/:messageId/read',
    ...withAuth('teacher'),
    withErrorHandler('mark teacher message read')(async (c: Context) => {
      ...
      triggerWebhookSafely(
        c.env,
        'message.read',
        { id: message.id, readAt: message.updatedAt, readBy: teacherId },
  ...
  app.delete(
    '/api/teachers/:id/messages/:messageId',
    ...withAuth('teacher'),
    withErrorHandler('delete teacher message')(async (c: Context) => {
      const messageId = c.req.param('messageId')
      const teacherId = getCurrentUserId(c)
      ...
      triggerWebhookSafely(
        c.env,
        'message.deleted',
        { id: messageId, deletedBy: teacherId },
        { messageId }
      )
