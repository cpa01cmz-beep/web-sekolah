...
export class AchievementEntity extends IndexedEntity<Achievement> {
  ...
  static readonly initialState = { id: "", title: "", description: "", date: "", category: "", image: "" };
...
export class NewsEntity extends IndexedEntity<NewsItem> {
  ...
  static readonly initialState = { id: "", title: "", content: "", excerpt: "", date: "", author: "", category: "", image: "" };
...
export class GalleryEntity extends IndexedEntity<GalleryItem> {
  ...
  static readonly initialState = { id: "", title: "", description: "", imageUrl: "", date: "", category: "" };
...
export class WorkEntity extends IndexedEntity<WorkItem> {
  ...
  static readonly initialState = { id: "", title: "", description: "", imageUrl: "", date: "", author: "" };
...
export class DownloadEntity extends IndexedEntity<DownloadItem> {
  ...
  static readonly initialState = { id: "", title: "", description: "", fileUrl: "", fileSize: "", fileType: "", date: "" };
