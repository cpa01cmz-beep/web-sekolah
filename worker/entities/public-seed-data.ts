  ...
  schoolProfile: [
    {
      ...
      description:
        'SMA Negeri 1 Jakarta adalah sekolah menengah atas unggulan yang berkomitmen untuk menghasilkan lulusan berkualitas dengan karakter yang kuat dan kompetensi global.',
      vision:
        'Menjadi sekolah unggulan yang menghasilkan lulusan berkarakter, berprestasi, dan berwawasan global.',
      mission:
        '1. Membentuk karakter siswa yang beriman, berakhlak mulia, dan berbudaya\n2. Mengembangkan potensi akademik dan non-akademik siswa secara optimal\n3. Menciptakan lingkungan belajar yang kondusif dan inovatif\n4. Membekali siswa dengan keterampilan abad 21',
      address:
        'Jl. Budi Utomo No.7, Ps. Baru, Kecamatan Sawah Besar, Kota Jakarta Pusat, Daerah Khusus Ibukota Jakarta 10710',
      phone: '(021) 3456789',
  ...
  services: [
    {
      ...
      description:
        'Layanan pendaftaran siswa baru untuk tahun ajaran berikutnya dengan sistem online yang terintegrasi.',
      icon: 'user-plus',
    },
    {
      id: 'svc-02',
      name: 'E-Learning',
      description:
        'Platform pembelajaran digital yang mendukung kegiatan belajar mengajar jarak jauh dan tatap muka.',
      icon: 'monitor',
    },
    {
      id: 'svc-03',
      ...
      description:
        'Akses ke ribuan buku digital, jurnal, dan sumber belajar online untuk seluruh warga sekolah.',
      icon: 'book-open',
    },
    {
      id: 'svc-04',
      name: 'Konseling BK',
      description:
        'Layanan bimbingan konseling untuk membantu siswa dalam pengembangan akademik dan karir.',
      icon: 'users',
    },
    {
      id: 'svc-05',
      name: 'UKS',
      description:
        'Unit Kesehatan Sekolah yang menyediakan layanan kesehatan dasar untuk warga sekolah.',
      icon: 'heart',
    },
    {
      id: 'svc-06',
  ...
  achievements: [
    {
      ...
      description:
        'Tim Olimpiade Matematika SMA Negeri 1 Jakarta berhasil meraih juara pertama dalam Olimpiade Matematika Tingkat Provinsi DKI Jakarta tahun 2025.',
      date: '2025-01-15',
      category: 'Akademik',
    ...
    },
    {
      ...
      description:
        'Tim Debat Bahasa Inggris meraih posisi runner-up dalam kompetisi debat bahasa Inggris tingkat nasional.',
      date: '2025-02-10',
      category: 'Akademik',
    ...
    },
    {
      ...
      description:
        'Atlet dari SMA Negeri 1 Jakarta berhasil meraih medali emas dalam cabang atletik pada PON XX Papua.',
      date: '2024-10-20',
      category: 'Olahraga',
  ...
  facilities: [
    {
      ...
      description:
        'Laboratorium komputer dengan 60 unit PC terbaru dan koneksi internet berkecepatan tinggi.',
    ...
    },
    {
      ...
      description:
        'Laboratorium IPA lengkap untuk praktikum Fisika, Kimia, dan Biologi dengan peralatan modern.',
  ...
  news: [
    {
      ...
      content:
        'SMA Negeri 1 Jakarta membuka pendaftaran siswa baru untuk tahun ajaran 2025/2026. Pendaftaran dapat dilakukan secara online melalui website resmi sekolah. Persyaratan dan jadwal lengkap dapat dilihat di halaman PPDB.\n\nPendaftaran dibuka mulai tanggal 1 Maret 2025 hingga 30 April 2025. Seleksi akan dilakukan dalam dua tahap, yaitu seleksi berkas dan seleksi wawancara.\n\nUntuk informasi lebih lanjut, silakan hubungi panitia PPDB di nomor (021) 3456789 atau email ppdb@sman1jakarta.sch.id.',
      excerpt:
        'Pendaftaran siswa baru tahun ajaran 2025/2026 dibuka mulai 1 Maret hingga 30 April 2025.',
      date: now,
    ...
    },
    {
      ...
      content:
        'Siswa SMA Negeri 1 Jakarta berhasil meraih medali emas dalam Olimpiade Sains Nasional (OSN) bidang Matematika. Prestasi ini merupakan bukti kerja keras dan dedikasi siswa serta pembinaan yang intensif dari para guru pembimbing.\n\nMedali emas diraih oleh Ahmad Rizki dari kelas XII IPA 1. Selain itu, dua siswa lainnya meraih medali perak dan perunggu dalam bidang Fisika dan Kimia.\n\nKepala Sekolah menyampaikan apresiasi atas prestasi yang diraih dan berharap dapat memotivasi siswa lain untuk terus berprestasi.',
      excerpt:
        'Ahmad Rizki dari kelas XII IPA 1 meraih medali emas OSN Matematika tingkat nasional.',
      date: now,
      author: 'Humas SMAN 1',
      category: 'Prestasi',
  ...
  works: [
    {
      ...
      description:
        'Aplikasi berbasis web untuk mengelola inventaris laboratorium komputer sekolah. Dibuat oleh tim siswa kelas XII RPL.',
    ...
    },
    {
      ...
      description:
        'Website profil ekstrakurikuler sekolah dengan fitur pendaftaran online dan jadwal kegiatan.',
    ...
    },
    {
      ...
      description:
        'Sistem presensi berbasis QR Code untuk kegiatan ekstrakurikuler dan organisasi siswa.',
